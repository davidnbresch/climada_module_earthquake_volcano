...
%   eq_data_prob = eq_global_probabilistic(eq_data) % create probabilistic
%   event set
...
%
% OUTPUTS:
%   A plot showing the relationship between earthquake magnitude (M) and 
%   its relative occurrence (N/N_tot, where N is the number
%   of events having a magnitude >=M and N_tot is the total number of
%   earthquakes in eq_data)
%
